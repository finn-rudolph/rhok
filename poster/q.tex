...
\draw[fill = c5, draw = none] (-50, 21.5) rectangle ++(100, 100);
\draw[fill = c2, draw = none] (-50, -30) rectangle ++(100, -100);

\begin{columns}
  \column{0.5}
  \block{\huge{\textbf{Das optimale $\boldsymbol{k}$ ist...}}}{
    \begin{center}
      \textcolor{c2}{\Huge{$\boldsymbol{k = 1}$}}
    \end{center}
    \vspace{2em}
    \large
  ...
  \block{}{
    \vspace{2.97em}
    \begin{center}
      \textcolor{c2}{\Huge{{$\boldsymbol{k_1 = k_2 = 1}$}}}
    \end{center}
    \vspace{2em}
    \large
...
\block{}
{
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \draw[dashed, draw = c2, line width = \lw] (1900, 450) to (2200, 400);
    \end{axis}
  \end{tikzpicture}
  \vspace{6.8cm}
}
