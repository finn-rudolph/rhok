...
\block{Zur Überprüfung der theoretischen Ergebnisse wurden Laufzeitmessungen durchgeführt.}
{
  \vspace*{5cm}
  \begin{tikzpicture}
    \begin{axis}[
        ...
        y label style={at={(axis description cs:0.1,1.12)},rotate=-90,anchor=north},
...
\note[
  ...
  gleicher Kurvenverlauf $\implies$ Die Formel beschreibt das Laufzeitverhalten der Rho-Methode gut.
}
