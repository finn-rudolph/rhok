...
% \draw[fill = c1, draw = none] (-50, 18.5) rectangle ++(100, 100);
\draw[fill = c1, draw = none] (-50, -30) rectangle ++(100, -100);

\block{\vspace{0.5em}\Huge{\textcolor{c3}{\textbf{Das optimale $\boldsymbol{k}$ ist...}}}\vspace{-1.5em}}{
}
\begin{columns}
  \column{0.5}
  \colorlet{framecolor}{c4}
  % \useblockstyle{framedblock}
  \block{}{
    \vspace{1em}
    \begin{center}
      \textcolor{c4}{\Huge{$\boldsymbol{k = 1}$}}
    \end{center}
    \vspace{1em}
    \color{c1}
  ...
  \column{0.5}
  \colorlet{framecolor}{c5}
  \block{}{
    \vspace{0.2em}
    \begin{center}
      \textcolor{c5}{\Huge{{$\boldsymbol{k_1 = k_2 = 1}$}}}
    \end{center}
    \vspace{1em}
    \color{c1}
    bei zwei Maschinen (vermutlich). Mit der Formel wurde bewiesen, dass $k_1 = k_2 = 1$ besser ist als zwei Primzahlen oder zwei gleiche Zahlen größer als 1. Auswertungen der Formel und Laufzeitmessungen suggerieren, das $k_1 = k_2 = 1$ tatsächlich optimal ist.
  }
