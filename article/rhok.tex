...
\begin{definition}
    ...
    \end{enumerate}
\end{definition}
Als Beispiel betrachte man $f$ aus Abbildung \ref{fig:fn-graph-17} mit $x = 15$. Es gilt $\mu(f, 15) = 1, \lambda(f, 15) = 6$ und $\rho(f, 15) = 7$. Hier tritt also nach siebenmaliger Anwendung von $f$ mit Anfangswert 15 erstmals eine Kollision auf.
