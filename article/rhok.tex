...
Um $\E(t_{\min}) \sim F$ zu zeigen, wird Induktion über $M$ verwendet. Die Induktionsvoraussetzung ist, dass eine (von $M$ abhängige) Konstante $c$ existiert, sodass $|\E(t_{\min}) - F| \le c$ für jedes $p$. Im Fall $M = 1$ gilt
\begin{align*}
    \lim_{p \to \infty} \frac {\E(t_{\min})} F
     & = \lim_{p \to \infty} 1 + \frac {\E(t_{\min}) - F} {F} \\
     & = 1 + \lim_{p \to \infty} \frac 1 {F}
