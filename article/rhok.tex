...
\begin{lemma}
    ...
    \begin{align*}
        \lim_{p \to \infty} \P(s = z)
        - \frac z h \exp \bigg ( \frac {-z^2}{2h} \bigg ) = 0
    \end{align*}
    wenn $z = O(\sqrt h)$ und
    \begin{align*}
        \P(s = z)
...
Sei im Folgenden $\P'(s_i = z_i) = \exp(-z_i^2/h_i)z_i/h_i$ und
\begin{align*}
    \E'(t_{\min}) =
    \sum_{z_1 = 1}^{h_1} \P'(s_1 = z_1)
    \sum_{z_2 = 1}^{h_2} \P'(s_2 = z_2) \, \cdots
    ...
    \, \min_{i = 1}^M(z_i \lg 2k_i)
\end{align*}
Mit Lemma \ref{lemma:prob-s-z-asmyp} soll nun $\E(t_{\min}) \sim \E'(t_{\min})$ gezeigt werden. Es gilt
\begin{align*}
    \lim_{p \to \infty} \frac {\E'(t_{\min})} {\E(t_{\min})}
     & = \lim_{p \to \infty}
