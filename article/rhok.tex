...
\end{align*}
Daraus folgt $\P(s = z) = O(Q(z, h))$. Das Ziel ist nun zu zeigen, dass $\E(t_{\min}) \sim F$.

\begin{lemma}
    Mit der Notation von Lemma \ref{lemma:prob-s-z} gilt für $p \to \infty$ und $z \le \sqrt h$
    \begin{align*}
