...
Der Parameter $k$ bestimmt in der Rho-Methode den Exponenten der Funktion $f : x \mapsto x^{2k} + 1$. Diese Funktion wird wiederholt auf einen zufällig gewählten Anfangswert $x_0$ angewandt. Wenn $f^{(m)}(x_0) = f^{(2m)}(x_0)$ ($f^{(m)}$ ist die $m$-malige Verkettung von $f$), findet die Rho-Methode einen Faktor.
...
\begin{definition}
    ...
    \end{enumerate}
\end{definition}
Als Beispiel betrachte man $f$ aus Abbildung \ref{fig:fn-graph-17} mit $x = 15$. Es gilt $\mu(f, 15) = 1, \lambda(f, 15) = 6$ und $\rho(f, 15) = 7$.
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \draw[->, draw = \cEdge] (2) -- (5);
        \draw[->, draw = \cEdge] (5) -- (9);
        \draw[->, draw = \cEdge] (9) -- (14);
        \draw[->, draw = \cEdge] (14) -- (10);
        \draw[->, draw = \cEdge] (10) -- (16);
        \draw[->, draw = \cEdge] (16) -- (2);
        \draw[->] (13) -- (0);
        \draw[->] (4) -- (0);
        \draw[->] (7) -- (16);
        \draw[->] (3) -- (10);
        \draw[->, draw = \cEdge] (15) -- (5);
        \draw[->] (12) -- (9);
        \draw[->] (6) -- (3);
        \draw[->] (11) -- (3);
        \draw[->] (8) -- (14);
