...
\begin{proof}
    Nach Abschnitt \ref{sec:start2} gilt $L_{1, 1}(p) \sim 25/32 \sqrt{\pi p /2}$, es gilt also in beiden Fällen zu zeigen, dass der Erwartungswert jeweils größer ist. Zunächst wird Teil 1 bewiesen. Da $k_1 \ne k_2$, kann (\ref{expectation-tmin}) verwendet werden.
    \begin{align*}
        L_{k_1, k_2}(p)
