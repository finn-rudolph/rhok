...
Der Parameter $k$ bestimmt in der Rho-Methode den Exponenten der Funktion $f : x \mapsto x^{2k} + 1$. Diese Funktion wird wiederholt auf einen zufällig gewählten Anfangswert $x_0$ angewandt, und wenn $f^{(m)}(x_0) = f^{(2m)}(x_0)$ ($f^{(m)}$ ist die $m$-malige Verkettung von $f$), findet die Rho-Methode einen Faktor.
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \node[circle, draw=magenta] (2) at (3, 0) {2};
        \node[circle, draw=magenta] (5) at (4, -1.3) {5};
        \node[circle, draw=magenta] (9) at (5.5, -1.3) {9};
        \node[circle, draw=magenta] (14) at (6.5, 0) {14};
        \node[circle, draw=magenta] (10) at (5.5, 1.3) {10};
        \node[circle, draw=magenta] (16) at (4, 1.3) {16};
        \node[circle, draw=black] (4) at (-1.1, -1.1) {4};
        \node[circle, draw=black] (13) at (-1.1, 1.1) {13};
        \node[circle, draw=magenta] (15) at (4, -2.7) {15};
        ...
        \draw[->] (0) -- (1);
        \draw[->] (1) -- (2);
        \draw[->, draw = magenta] (2) -- (5);
        \draw[->, draw = magenta] (5) -- (9);
        \draw[->, draw = magenta] (9) -- (14);
        \draw[->, draw = magenta] (14) -- (10);
        \draw[->, draw = magenta] (10) -- (16);
        \draw[->, draw = magenta] (16) -- (2);
        \draw[->] (13) -- (0);
        \draw[->] (4) -- (0);
        \draw[->] (7) -- (16);
        \draw[->] (3) -- (10);
        \draw[->, draw = magenta] (15) -- (5);
        \draw[->] (12) -- (9);
        \draw[->] (6) -- (3);
        \draw[->] (11) -- (3);
        \draw[->] (8) -- (14);
...
\begin{figure}
    \centering
    \begin{tikzpicture}
        \draw[draw = red, thick] (4.45, 2.38) circle [x radius=0.5, y radius=0.2, rotate = 325];
        \draw[draw = red, thick] (4.45, 3.57) circle [x radius=0.5, y radius=0.2, rotate = 25];
