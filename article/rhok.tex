...
\end{align*}
wobei $[x^n]$ den $n$-ten Koeffizienten in der Reihenentwicklung des nachstehenden Terms bezeichnet. Folgende Komponenten werden als Grundlage verwendet, um einen funktionalen Graphen zu konstruieren (\cite{fo90}, S. 333).
\begin{align*}
...
\noindent Um für die Koeffizienten von $((\partial / \partial w) \Psi(x, w)) |_{w = 1}$ eine asymptotische Näherung zu bestimmen, wird folgender Satz von \cite{fo90} verwendet. Der Vollständigkeit halber wird er hier erneut formuliert.
