...
\end{align*}
Da immer $r_i < h_i$ gilt, geht das gegen 0 für $h_i \to \infty$. Das reicht allerdings noch nicht, um zu zeigen, dass Terme in (\ref{etmin}) mit $r_i > h_i^{3/5}$ gegen 0 gehen für $h_i \to \infty$. Da $\min_{i = 1}^M (r_i \lg 2k_i)$ durch $p$ beschränkt ist, folgt dies aber sofort.
